...
Definition ltb {n1 n2 : Z} (v1 v2 : value) (pf1 : v1 = VInteger n1) (pf2 : v2 = VInteger n2) :=
    Z.ltb n1 n2.
Notation "v1 <? v2" := (ltb v1 v2 eq_refl eq_refl) : vp_scope.

Definition leb {n1 n2 : Z} (v1 v2 : value) (pf1 : v1 = VInteger n1) (pf2 : v2 = VInteger n2) :=
    Z.leb n1 n2.
Notation "v1 <=? v2" := (leb v1 v2 eq_refl eq_refl) : vp_scope.

Definition geb {n1 n2 : Z} (v1 v2 : value) (pf1 : v1 = VInteger n1) (pf2 : v2 = VInteger n2) :=
    Z.geb n1 n2.
Notation "v1 >=? v2" := (geb v1 v2 eq_refl eq_refl) : vp_scope.

Definition add {n1 n2 : Z} (v1 v2 : value) (pf1 : v1 = VInteger n1) (pf2 : v2 = VInteger n2) :=
    Z.add n1 n2.
Notation "v1 + v2" := (add v1 v2 eq_refl eq_refl) : vp_scope.

Definition sub {n1 n2 : Z} (v1 v2 : value) (pf1 : v1 = VInteger n1) (pf2 : v2 = VInteger n2) :=
    Z.sub n1 n2.
Notation "v1 - v2" := (sub v1 v2 eq_refl eq_refl) : vp_scope.
...
Definition get_array (VOLPIC_store : store) (s : id_type) : list value :=
    match sf_get VOLPIC_store s with
    | VArray l => l
    | _ => []
    end.

Definition subscript (l : list value) (idx : Z) (default : value) : value :=
...
Definition fpc_dynarray_high {T: Type} {n: nat}
    ...
    update s "VP_result"%string (VInteger ((Z.of_nat (List.length l)) - 1)).
